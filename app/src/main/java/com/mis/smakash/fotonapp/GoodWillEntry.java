...
public class GoodWillEntry extends AppCompatActivity {
    ...
    private EditText chassis, instcustomername, instmobilenumber,  insthoureofbuy, instdateofbuy,
            instdateofinstallation, instdateofendofservice,inserviceincome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_good_will_entry);
        ...
        btnprevious.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                btnprevious.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if(isEdit.equalsIgnoreCase("1")){
                            Intent nextActivity = new Intent(GoodWillEntry.this, ServiceType.class);
                        ...
                        if(isEdit.equalsIgnoreCase("0")){
                            Intent previousActivity = new Intent(GoodWillEntry.this, ServiceType.class);
